...
<?php 
 ...
 ?>
						<tr class="odd gradeX">
							...
							<td><?php echo $result['memTitle'] ?></td>
							<td><img width="70px" src="<?php echo $result['image'] ?>"></td>
							<td><a href="teamEdit.php?editTeam=<?php echo $result['id']?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
